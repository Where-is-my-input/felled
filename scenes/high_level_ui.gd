...
@onready var btn_host: Button = $MenuPanel/btnHost
@onready var btn_join: Button = $MenuPanel/btnJoin
@onready var btn_settings: Button = $MenuPanel/btnSettings
@onready var btn_quit: Button = $MenuPanel/btnQuit

@onready var join_panel: VBoxContainer = $JoinPanel
@onready var ip: LineEdit = $JoinPanel/ip
@onready var port: LineEdit = $JoinPanel/port
@onready var btn_connect: Button = $JoinPanel/btnConnect
@onready var btn_join_back: Button = $JoinPanel/btnJoinBack

@onready var settings_panel: VBoxContainer = $SettingsPanel
@onready var btn_settings_back: Button = $SettingsPanel/btnSettingsBack
